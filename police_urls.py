...
from Crime.police_views import IndexView, AddCriminals, ViewCriminals, DeleteCriminals, ApproveFIR, ApprFIR, RejectFIR, \
    ViewFIR, ViewMissing, ViewUser, Fir_details, viewFir, fir_file_view, add_evidence, view_evidence, \
    evidence_details_view, \
    update_evidence, fir_Approved, editCriminals
from django.contrib.auth import views as auth_views
urlpatterns = [

    path('',IndexView.as_view()),
    path('AddCriminals',AddCriminals.as_view()),
    path('editCriminals', editCriminals.as_view()),
