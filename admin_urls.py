...
from Crime.admin_views import IndexView, AddStation, ViewStation, DeletePolice, NewStation, RejectView, ApproveView, \
    ApprovedStation, ViewCriminals, ViewFeed, ViewUser, ViewFIR, Officer_approve, view_officer,Profile_details,editStation
...
urlpatterns = [
    ...
    path('edit',editStation.as_view()),

    path('ViewCriminals',ViewCriminals.as_view()),
    path('Officer_approve',Officer_approve.as_view()),
    path('view_officer',view_officer.as_view(),name='view_officer'),
