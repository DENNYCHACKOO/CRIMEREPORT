...
from Crime.user_views import IndexView, ViewCriminals, AddFeedback, SelectStation,View_complaint, \
    Complaint_reg,add_evidence_view,missing_view,View_Evidence,Evidence,Deleteev
...
urlpatterns = [
    ...
    path('View_Evidence',View_Evidence.as_view(),name='View_Evidence'),
    path('Evidence',Evidence.as_view(),name='Evidence'),
    path('Deleteev', Deleteev.as_view()),
